...
func init() {
	RegisterCompressor("zstd", NewCompressorZstd(zstd.SpeedDefault))
	RegisterCompressor("zstd_better_compression", NewCompressorZstd(zstd.SpeedBetterCompression))
	RegisterCompressor("zstd_best_compression", NewCompressorZstd(zstd.SpeedBestCompression))
	RegisterCompressor("zstd_fastest_compression", NewCompressorZstd(zstd.SpeedFastest))
}
